...
@section('title', "Post Edit | JU Press Club")
@section('pageTitle')
...
@section('mainContent')
    <div class="panel-heading">
        <h3 class="panel-title text-uppercase">Post Edit</h3>
    </div>
    <div class="panel-body">
        <form role="form" action="{{route('admin.posts.update', $data->id)}}" method="post" enctype="multipart/form-data">
            @csrf
            @method('put')
            ...
            <div class="form-group">
                ...
                <div class="checkbox checkbox-success">
                    <input id="checkbox3" {{$featured == 1 ? 'checked':''}} name="is_featured" value="one" type="checkbox">
                ...
                <div>
                    @foreach($tags as $tag)
                        <div class="radio radio-success">
                            <input type="radio" {{$tag->id == $tag_id ? 'checked':''}} name="tag_id" id="radio1" value="{{$tag->id}}">
