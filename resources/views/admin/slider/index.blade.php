...
@section('title', "Sliders | JU Press Club")
@section('pageTitle')
    <h4 class="pull-left page-title text-uppercase">Sliders</h4>
    ...
    <div class="panel-body">
        <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
            ...
            <tr>
                ...
                <td>
                    <a href="{{route('admin.sliders.edit', $data->id)}}" class="btn btn-success"><i class="fa fa-edit"></i></a>
                    <button class="btn btn-danger" type="button" onclick="deleteSlider({{$data->id}})">
                        <i class="fa fa-trash-o"></i>
                    </button>
                    <form id="delete_from_{{$data->id}}" style="display: none" action="{{route('admin.sliders.destroy', $data->id)}}" method="post">
                        @csrf
                        @method('delete')
                    </form>
