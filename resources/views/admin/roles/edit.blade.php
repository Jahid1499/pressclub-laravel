...
@section('pageTitle')
    <h4 class="pull-left page-title text-uppercase">role edit</h4>
...
@section('mainContent')
    <div class="panel-heading">
        <h3 class="panel-title text-uppercase"><span>{{$data->name}}</span> Role Edit</h3>
    </div>
    <div class="panel-body">
        <form role="form" action="{{route('admin.roles.update', $data->id)}}" method="post">
            @csrf
            @method('put')
