...
@section('title', "Image Gallery Edit | JU Press Club")
@section('pageTitle')
    <h4 class="pull-left page-title"></h4>
    <ol class="breadcrumb pull-right">
        <li><a href="{{route('admin.dashboard')}}">Dashboard</a></li>
        <li><a href="{{route('admin.images.index')}}">Image Gallery</a></li>
        <li class="active">Image Gallery Edit</li>
    </ol>
@endsection

@section('mainContent')
    <div class="panel-heading">
        <h3 class="panel-title text-uppercase">Image Gallery Edit</h3>
    </div>
    <div class="panel-body">
        <form role="form" action="{{route('admin.images.update', $data->id)}}" method="post" enctype="multipart/form-data">
            @csrf
            @method('put')

            <div class="form-group" style="width: 30%;">
                <img src="{{asset($data->small_image)}}" alt="" class="img-responsive" style="width: 50%; height: 4%;">
            </div>
