...
@section('title', "Notice Create | JU Press Club")
@section('pageTitle')
    <h4 class="pull-left page-title text-uppercase">Notice Create</h4>
...
@section('mainContent')
    <div class="panel-heading">
        <h3 class="panel-title text-uppercase">Notice Create</h3>
    </div>
    <div class="panel-body">
        <form role="form" action="{{route('admin.notices.store')}}" method="post" enctype="multipart/form-data">
            ...
            <a href="{{route('admin.notices.index')}}" class="btn btn-info waves-effect waves-light">Back</a>
        </form>
    </div>
@endsection
