...
@section('title', "Executive Member Edit | JU Press Club")
@section('pageTitle')
    <h4 class="pull-left page-title">Executive Member Edit</h4>
    <ol class="breadcrumb pull-right">
        <li><a href="{{route('admin.dashboard')}}">Dashboard</a></li>
        <li><a href="{{route('admin.executives.index')}}">Executive Member List</a></li>
        <li class="active">Executive Member Edit</li>
    </ol>
@endsection

@section('mainContent')
    <div class="panel-heading">
        <h3 class="panel-title text-uppercase">Executive Member edit</h3>
    </div>
    <div class="panel-body">
        <form role="form" action="{{route('admin.executives.update', $data->id)}}" method="post" enctype="multipart/form-data">
            @csrf
            @method('put')
