...
@section('pageTitle')
    <h4 class="pull-left page-title">Member Edit</h4>
...
@section('mainContent')
    <div class="panel-heading">
        <h3 class="panel-title text-uppercase">Member edit</h3>
    </div>
    <div class="panel-body">
        <form role="form" action="{{route('admin.members.update', $data->id)}}" method="post" enctype="multipart/form-data">
            @csrf
            @method('put')
